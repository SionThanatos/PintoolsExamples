...
VOID ImageManager::addImage(string image_name, ADDRINT lo_addr,ADDRINT hi_addr) 
{
...
// Checks if the given address falls inside one of the white-listed images we are tracing.
